...
### 📁 07_SHORTCUTS/
- `Claude Code - CENOTE.lnk` - Shortcut to Claude Code application
...
**Note**: This repository contains no source code, development tools, build systems, or technical infrastructure. It is purely a business documentation repository. Any development work would likely be related to:
...
- Create or update presentation materials
...
- **Master Document**: `💙_CENOTE_DOCUMENTO_MAESTRO.md` contains all consolidated company information
- **Financial Analysis**: Files in `02_ANALISIS_FINANCIERO/` contain detailed financial projections
- **Organizational Structure**: Files in `03_ESTRUCTURA_ORGANIZACIONAL/` contain company structure and procedures
- **Presentations**: Files in `05_PRESENTACIONES_SOCIOS/` and `06_PRESENTACIONES_HTML/` contain investor materials

## Languages and Content

- Primary language: Spanish
- Content type: Business documentation, financial projections, strategic planning
- Format: Markdown documentation with HTML presentations
